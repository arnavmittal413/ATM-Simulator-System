...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne(){
        ...
        JLabel personalDetails=new JLabel("Page 1 : Persoanl Details");
    ...
    public void actionPerformed(ActionEvent ac){
        ...
        try{
            if(name.equals("")){
                ...
                Cone c=new Cone();
                String query="insert into signup value('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+martial+"','"+address+"','"+city+"','"+state+"','"+pincode+"')";
